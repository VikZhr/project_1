В данном учебном проекте было решено несколько задач по исследованию аспектов компании, разрабатывающей мобильные игры.
...
Проверил гипотезы, проанализировала результаты А/B-теста с использованием статистических тестов в Python (Bootstrap).
